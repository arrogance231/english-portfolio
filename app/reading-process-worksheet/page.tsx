    ...
    <div className="relative h-screen w-screen flex overflow-hidden">
      ...
      <div className="relative h-full w-full overflow-hidden">
        <div className="absolute inset-0 flex flex-col xl:px-[100px] px-4">
          <SidebarDemo />
          <div className="animate-appearFromCenter text-white xl:mx-auto xl:my-8 md:mx-32 mx-5 my-4 p-4 md:p-8 xl:w-full xl:h-full overflow-y-auto animate-gradient bg-gradient-to-t from-[#133B5C]/50 to-[#FFA6AF]/50">
            <h1 className="text-2xl md:text-4xl font-bold mb-8">
              Reading Process Worksheet 1
            </h1>
            <div className="grid h-full w-full rounded-x">
              <section className="mb-8">
                <h2 className="text-2xl md:text-8xl font-semibold mb-4">
                  Pre-Reading
                </h2>
                <h3 className="my-10">
                ...
                <table className="table-auto w-full mb-8">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border px-2 md:px-4 py-2">Row 2, Col 3</td>
                    </tr>
                  </tbody>
                </table>
              </section>
              ...
              <section className="mb-8">
                ...
                <table className="table-auto w-full mb-8">
                  <tbody>
                    ...
                    <tr>
                      <td className="border px-2 md:px-4 py-2">Row 2, Col 1</td>
                      <td className="border px-2 md:px-4 py-2">Row 2, Col 2</td>
                      <td className="border px-2 md:px-4 py-2">Row 2, Col 3</td>
                    </tr>
                    <tr>
                      <td className="border px-2 md:px-4 py-2">Row 3, Col 1</td>
                      <td className="border px-2 md:px-4 py-2">Row 3, Col 2</td>
                      <td className="border px-2 md:px-4 py-2">Row 3, Col 3</td>
                    </tr>
                  </tbody>
                </table>
                <table className="table-auto w-full mb-8">
                  <tbody>
                    ...
                    <tr>
                      <td className="border px-2 md:px-4 py-2">Row 4, Col 1</td>
                      <td className="border px-2 md:px-4 py-2">Row 4, Col 2</td>
                      <td className="border px-2 md:px-4 py-2">Row 4, Col 3</td>
                    </tr>
                    <tr>
                      <td className="border px-2 md:px-4 py-2">Row 5, Col 1</td>
                      <td className="border px-2 md:px-4 py-2">Row 5, Col 2</td>
                      <td className="border px-2 md:px-4 py-2">Row 5, Col 3</td>
                    </tr>
                  </tbody>
                </table>
              </section>
